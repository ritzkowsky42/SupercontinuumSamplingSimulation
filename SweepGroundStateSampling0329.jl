...
signal = CSV.read("FilteredWaveformSCG0329.csv", DataFrame)
...
CSV.write("SampledWaveform15Vnm0329.csv", DataFrame(time = delayVals*t0, field = qAvg./maximum(qAvg)), writeheader = true)
